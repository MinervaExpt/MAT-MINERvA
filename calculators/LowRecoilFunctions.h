...
double GetSubdetSum(const std::vector<Subdet>& subdets, bool fuzz = false) const {
  double result = 0;
  for (std::vector<Subdet>::const_iterator it = subdets.begin();it!=subdets.end();++it) {
    double e = GetSubdetE(*it) - (fuzz? GetSubdetFuzz(*it) : 0);
    result += std::max(0.0,e);
  }
  return result;
}
...
bool LoadNukeCC_Nu_Tracker() {
  ...
  points.push_back(std::make_pair(1.05282,1.0433));
  points.push_back(std::make_pair(1.41762,1.43065));
  points.push_back(std::make_pair(1.89408,1.9389));
  points.push_back(std::make_pair(2.38637,2.43997));
  points.push_back(std::make_pair(2.88095,2.93705));
  points.push_back(std::make_pair(3.37431,3.43602));
  points.push_back(std::make_pair(5.07854,5.15973));
  points.push_back(std::make_pair(10.6784,10.7691));
  points.push_back(std::make_pair(15.931,15.9287));
  points.push_back(std::make_pair(25.6898,25.6322));
  points.push_back(std::make_pair(50.,50.));
  std::vector<double> x;
  std::vector<double> y;
