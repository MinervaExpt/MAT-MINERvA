...
class HyperDimLinearizer {
   public:
    ...
    std::vector<TH2D*> Get2DHistos(PlotUtils::MnvH1D* result, bool IncludeSys);                  // for 1D types
    std::vector<PlotUtils::MnvH2D*> Get2DMnvHistos(PlotUtils::MnvH1D* result, bool IncludeSys);  // for 1D types
