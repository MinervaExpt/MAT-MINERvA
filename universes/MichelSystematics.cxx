...
namespace Minerva {
  ...
  std::vector<T*> GetMichelEfficiencySystematics(typename T::config_t chain, double fracUncertainty = NSFDefaults::MichelTagEfficiency_Err ) {
    ...
    ret.push_back(new Minerva::MichelEfficiencyUniverse<T>(chain, -1., fracUncertainty));
    ret.push_back(new Minerva::MichelEfficiencyUniverse<T>(chain, 1., fracUncertainty));
  ...
  std::map< std::string, std::vector<T*> > GetMichelEfficiencySystematicsMap(typename T::config_t chain, double fracUncertainty = NSFDefaults::MichelTagEfficiency_Err ) {
    ...
    ret["MichelEfficiency"].push_back(new Minerva::MichelEfficiencyUniverse<T>(chain, -1., fracUncertainty));
    ret["MichelEfficiency"].push_back(new Minerva::MichelEfficiencyUniverse<T>(chain, 1., fracUncertainty));
...
// Constructor
template<typename T>
Minerva::MichelEfficiencyUniverse<T>::MichelEfficiencyUniverse(
...
template<typename T>
double Minerva::MichelEfficiencyUniverse<T>::GetMichelEfficiencyWeight() const {
...
template<typename T>
std::string Minerva::MichelEfficiencyUniverse<T>::ShortName() const { return "MichelEfficiency"; }

template<typename T>
std::string Minerva::MichelEfficiencyUniverse<T>::LatexName() const { return "Michel Tag Efficiency"; }
