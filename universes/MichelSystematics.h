...
template <class T>
class MichelRangeDetectorMassUniverse : public T {
 public:
  MichelRangeDetectorMassUniverse(typename T::config_t chw, double nsigma);
